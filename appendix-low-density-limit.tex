...
For an isotropic system the pair distribution function $g^{(2)}(\vb{r}_1, \vb{r}_2)$ is a function only of a separation $r = \abs{\vb{r}_1 - \vb{r}_2}$, and the low-density limit is equal to the Boltzman factor $e(r)$ of a pair interaction potential $v(r)$, see e.g. Section~2.6 in~\cite{HansenMcDonald13}:
\begin{equation*}
