...
\title{Pair distribution function for the cell fluid model with Curie-Weiss interaction}
...
\abstract{In this paper we present results for the pair distribution function for the cell fluid model with Curie-Weiss interaction}
...
\keywords{Pair distribution function, $n-$particle density, Curie-Weiss interaction, cell fluid model}
